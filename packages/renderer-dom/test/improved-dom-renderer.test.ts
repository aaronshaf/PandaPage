      ...
      elements: [
        {
          ...
          rows: [
            {
              cells: [
                { paragraphs: [{ type: 'paragraph', runs: [{ text: 'Header 1', bold: true }] }], isHeader: true },
                { paragraphs: [{ type: 'paragraph', runs: [{ text: 'Header 2', bold: true }] }], isHeader: true }
              ]
            },
            {
              cells: [
      ...
      elements: [
        {
          ...
          rows: [
            ...
            {
              cells: [
                { paragraphs: [{ type: 'paragraph', runs: [{ text: 'Below merged', bold: false }] }] }
              ]
            }
          ]
        }
