...
export function applyPageStyles(pageDiv: HTMLElement, parsedDoc: ParsedDocument, pageIndex: number): void {
...
export function applyContentStyles(contentDiv: HTMLElement, parsedDoc: ParsedDocument, pageIndex: number): void {
