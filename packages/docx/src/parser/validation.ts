 ...
 */
export const validateTableBorders = (
  borders: unknown,
): Effect.Effect<DocxTableBorders, DocxParseError> =>
  Effect.try({
    try: () => {
 ...
 */
export const validateTableProperties = (
  properties: unknown,
 ...
 */
export const validateTableRowProperties = (
  properties: unknown,
 ...
 */
export const validateTableCellProperties = (
  properties: unknown,
