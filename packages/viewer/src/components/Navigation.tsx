...
import type { ParsedDocument } from "@browser-document-viewer/core";
...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40" data-testid="app-header">
      {/* Primary Header */}
      <div
        className={`bg-white shadow-sm border-b border-gray-200 overflow-hidden transition-all duration-300 ease-in-out ${
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2 min-w-0 flex-1">
              ...
              <div className="flex items-center gap-2 min-w-0">
                <h1
                  className={`text-lg sm:text-xl font-semibold text-gray-900 truncate ${documentTitle ? "document-title" : ""}`}
                            ...
                            <div className="space-y-4 text-sm">
                              ...
                              {metadata.createdDate && (
                                <div>
                                  ...
                                  <div className="text-gray-900">
                                    {new Date(metadata.createdDate).toLocaleDateString("en-US", {
                                      year: "numeric",
                                      month: "long",
                                      day: "numeric",
                                      hour: "2-digit",
                              ...
                              {metadata.modifiedDate && (
                                <div>
                                  ...
                                  <div className="text-gray-900">
                                    {new Date(metadata.modifiedDate).toLocaleDateString("en-US", {
                                      year: "numeric",
                                      month: "long",
                                      day: "numeric",
                                      hour: "2-digit",
            ...
            >
              {/* Document dropdown */}
              <div
                className="flex items-center gap-2 bg-gray-50 rounded-lg px-2 sm:px-3 py-2 shadow-sm border border-gray-200"
                data-testid="document-selector-wrapper"
              >
                <label
                  htmlFor="document-select"
                  className="hidden sm:inline text-sm font-medium text-gray-700 whitespace-nowrap"
                  data-testid="document-selector-label"
                >
                  Document:
                </label>
                <select
                  ...
                  className="text-sm border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 px-2 sm:px-3 py-1.5 sm:py-2 pr-8 sm:pr-10 bg-white shadow-sm font-medium w-36 sm:w-64 md:w-80"
                >
                  {uploadedFile && <option value="uploaded">{uploadedFile.name}</option>}
              ...
              <div className="relative" data-testid="upload-button-wrapper">
                ...
                >
                  ...
                  <span className="hidden sm:inline" data-testid="upload-button-text">
                    Upload
                  </span>
                </label>
              </div>
        ...
        <div className="px-3 sm:px-6 lg:px-8 py-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-4 overflow-x-auto">
              {/* View mode buttons */}
              <div
                className="flex items-center bg-white rounded-md shadow-sm"
                data-testid="view-mode-buttons"
              >
                <button
