...
test.describe('DocumentViewer Logic', () => {
  ...
  test.describe('Scroll Progress Calculation', () => {
    test('should calculate scroll progress correctly', () => {
      const calculateScrollProgress = (scrollTop: number, scrollHeight: number, clientHeight: number) => {
  ...
  test.describe('Page Indicator Positioning', () => {
    test('should calculate page indicator position within scrollbar area', () => {
      ...
      const topPosition = calculateIndicatorPosition(0, navHeight, scrollbarHeight, scrollbarOffset, windowHeight);
      expect(topPosition).toBeGreaterThan(navHeight);

      const middlePosition = calculateIndicatorPosition(0.5, navHeight, scrollbarHeight, scrollbarOffset, windowHeight);
      expect(middlePosition).toBeGreaterThan(topPosition);

      const bottomPosition = calculateIndicatorPosition(1, navHeight, scrollbarHeight, scrollbarOffset, windowHeight);
