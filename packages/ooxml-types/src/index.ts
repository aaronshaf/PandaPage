...
export type {
  ...
  CT_AudioFile, CT_VideoFile, CT_QuickTimeFile, CT_AudioCDTime, CT_AudioCD,
  EG_Media, ST_StyleMatrixColumnIndex, ST_FontCollectionIndex, ST_ColorSchemeIndex,
  CT_ColorScheme, CT_CustomColor, CT_SupplementalFont, CT_CustomColorList, CT_TextFont
...
export type {
  // Add specific SML exports here
} from './sml';

// PresentationML - Export only non-conflicting types  
export type {
  // Add specific PML exports here
} from './pml';
