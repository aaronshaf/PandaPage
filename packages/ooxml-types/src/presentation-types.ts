...
import type { ST_Coordinate, CT_PositiveSize2D, CT_EmbeddedWAVAudioFile, CT_OfficeArtExtensionList, ST_Percentage, ST_PositiveFixedPercentage, ST_Angle, CT_Color, CT_Point2D, CT_TextListStyle, CT_TextFont, CT_NonVisualDrawingProps, CT_NonVisualDrawingShapeProps, CT_ShapeProperties, CT_ShapeStyle, CT_TextBody, CT_NonVisualConnectorProperties, CT_BlipFillProperties, CT_NonVisualGraphicFrameProperties, CT_GraphicalObject, CT_Transform2D, ST_BlackWhiteMode, CT_NonVisualGroupDrawingShapeProps, CT_GroupShapeProperties, CT_BackgroundFormatting, CT_WholeE2oFormatting, EG_Media, CT_ColorMapping, CT_ColorMappingOverride, CT_StyleMatrixReference } from './dml-main';
