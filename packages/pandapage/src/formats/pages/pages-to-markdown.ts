...
import { PagesDocument, readPages } from "./pages-reader";
...
export const pagesToMarkdown = (buffer: ArrayBuffer): Effect.Effect<string, import("./pages-reader").PagesParseError> =>
  Effect.gen(function* () {
