...
import { PptxDocument, PptxSlide, PptxContent, readPptx } from "./pptx-reader";
...
export const pptxToMarkdown = (buffer: ArrayBuffer): Effect.Effect<string, import("./pptx-reader").PptxParseError> =>
  Effect.gen(function* () {
