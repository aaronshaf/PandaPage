...
export function formatSample3Text(extractedText: string): string {
  ...
  // Step 2: Fix the multi-part question structure with proper header spacing
  formatted = formatted.replace(
  ...
  // AI feedback specifically mentions "libero." breaks - ensure all instances are covered
  const paragraphBreaks = [
    'per inceptos himenaeos. Curabitur sodales ligula in libero.', // First instance
    'Curabitur sodales ligula in libero.', // Explicitly mentioned by AI feedback
